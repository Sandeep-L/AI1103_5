...
\begin{proof}
    Let us now prove (0.0.6) from (0.0.5) in \textit{Lemma} 1
    \begin{align}
        \pr{Y=k} &= \pr{ka\leq X < \brak{k+1}a}\\
...
From (0.0.1), $Y$ doesn't take any value in \brak{4,5}.
Therefore, option \\ \textbf{1)} $\pr{4<Y<5}=0$ is correct.\\

From (0.0.14), we can say that $Y$ follows \textit{\textbf{Geometric Distribution}}.\\
